                            ...
                            <form action="{{ route('store.promotion') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input
                                        ...
                                        placeholder="Masukkan judul promosi, contoh: Diskon 20% Akhir Tahun">
                                    @error('title')
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Masukkan deskripsi promosi (opsional)">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    <label class="block mb-2 font-medium text-gray-700 dark:text-gray-100"
                                        for="image">Gambar Banner <span class="text-red-500">*</span></label>
                                    <input
                                    ...
                                    @error('image')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Format: JPG, JPEG, PNG, WEBP. Maksimal 2MB. Ukuran rekomendasi: 1400x440px (landscape)</p>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            type="text" id="button_text" name="button_text" value="{{ old('button_text') }}"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            type="text" id="button_url" name="button_url" value="{{ old('button_url') }}"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            type="date" id="start_date" name="start_date" value="{{ old('start_date') }}">
                                        @error('start_date')
                                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                        @enderror
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Kosongkan untuk tanpa batas waktu mulai</p>
                                    </div>
                                    <div>
                                        <label class="block mb-2 font-medium text-gray-700 dark:text-gray-100"
                                        ...
                                        <input
                                            ...
                                            type="date" id="end_date" name="end_date" value="{{ old('end_date') }}">
                                        @error('end_date')
                                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                        @enderror
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Kosongkan untuk tanpa batas waktu selesai</p>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input
                                        ...
                                        type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', 0) }}"
                                        min="0" placeholder="0">
                                    @error('sort_order')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
