...
@section('title')
    <title>Halaman Fasilitas Route</title>
@endsection
                        ...
                        <div class="card-body border-b border-gray-100 dark:border-zinc-600">
                            <div class="flex justify-between items-center">
                                <h6 class="mb-0 text-gray-700 text-15 dark:text-gray-100 font-semibold">
                                    Daftar Fasilitas Route
                                </h6>
                                <a href="{{ route('create.route_facilitie') }}"
                                            ...
                                            <tr
                                                ...
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    <span
                                                        ...
                                                        <i class="fas fa-check-circle mr-1"></i>{{ $item->label }}
                                                    </span>
                                                </td>
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                ...
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    <div class="flex gap-2">
                                                        <a href="{{ route('edit.route_facilitie', $item->id) }}"
                                                            class="text-yellow-600 hover:text-yellow-800 dark:text-yellow-400 dark:hover:text-yellow-300"
                                                            title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="{{ route('destroy.route_facilitie', $item->id) }}"
                                            ...
                                            <tr>
                                                <td colspan="5"
                                                    ...
                                                    <div class="flex flex-col items-center">
                                                        ...
                                                        <p>Belum ada data fasilitas route</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
