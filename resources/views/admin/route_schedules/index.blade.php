...
@section('title')
    <title>Halaman Jadwal Route</title>
@endsection
                    ...
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <div class="card-body border-b border-gray-100 dark:border-zinc-600">
                            <div class="flex justify-between items-center">
                                ...
                                <a href="{{ route('create.route_schedule') }}"
                                            ...
                                            <tr
                                                ...
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    <span
                                                        ...
                                                        {{ $item->getScheduleTypeLabel() }}
                                                    </span>
                                                </td>
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    @if ($item->schedule_type === 'dow')
                                                        <span class="text-gray-700 dark:text-gray-300">
                                                            {{ $item->getDayOfWeekLabel() }}
                                                        </span>
                                                    @elseif($item->schedule_type === 'date')
                                                        <span class="text-gray-700 dark:text-gray-300">
                                                ...
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    <span
                                                        class="px-2 py-1 text-xs font-semibold bg-yellow-100 text-yellow-800 rounded dark:bg-yellow-900 dark:text-yellow-100">
                                                        <i
                                                            class="far fa-clock mr-1"></i>{{ date('H:i', strtotime($item->depart_time)) }}
                                                    </span>
                                                </td>
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    {{ $item->note ?? '-' }}
                                                ...
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    <div class="flex gap-2">
                                                        <a href="{{ route('show.route_schedule', $item->id) }}"
                                                            class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
                                                            title="Lihat Detail">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('edit.route_schedule', $item->id) }}"
                                                            class="text-yellow-600 hover:text-yellow-800 dark:text-yellow-400 dark:hover:text-yellow-300"
                                                            title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="{{ route('destroy.route_schedule', $item->id) }}"
                                            ...
                                            <tr>
                                                <td colspan="8"
                                                    ...
                                                    <div class="flex flex-col items-center">
                                                        ...
                                                        <p>Belum ada data jadwal route</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
