                    ...
                    <div class="card-body">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 ml-3">
                                <p class="text-sm text-gray-500 dark:text-gray-400">Total Testimoni</p>
                                <p class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ $testimonials->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 ml-3">
                                ...
                                <p class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ $testimonials->where('is_active', true)->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 ml-3">
                                ...
                                <p class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ $testimonials->where('is_active', false)->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="text-sm text-left text-gray-500 w-full">
                                    ...
                                    <tbody>
                                        @forelse ($testimonials as $item)
                                            <tr
                                                class="bg-white border-b border-gray-50 dark:bg-zinc-700 dark:border-zinc-600 {{ !$item->is_active ? 'bg-amber-50 dark:bg-amber-900/10' : '' }}">
                                                <th scope="row"
                                                ...
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    <div class="flex items-center gap-2">
                                                        {{ $item->name }}
                                                        @if(!$item->is_active)
                                                            <span class="px-2 py-0.5 text-xs font-semibold text-amber-800 bg-amber-100 rounded-full dark:bg-amber-900 dark:text-amber-200">Baru</span>
                                                        @endif
                                                    </div>
                                                </td>
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    {{ $item->position }}@if($item->position && $item->company), @endif{{ $item->company }}
                                                </td>
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    <div class="flex items-center text-amber-400">
                                                        @for($i = 1; $i <= 5; $i++)
                                                            ...
                                                            @endif
                                                        @endfor
                                                        <span class="ml-2 text-gray-600 dark:text-gray-300">({{ $item->rating }})</span>
                                                    </div>
                                                </td>
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    @if ($item->is_active)
                                                    ...
                                                    @else
                                                        <span
                                                            class="px-3 py-1 text-xs font-semibold text-amber-800 bg-amber-100 rounded border border-amber-300 dark:bg-amber-900 dark:text-amber-100 dark:border-amber-700 animate-pulse">⏳ Pending Review</span>
                                                    @endif
                                                </td>
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    <div class="flex gap-2">
                                                        @if(!$item->is_active)
                                                            <form action="{{ route('toggle.testimonial', $item->id) }}" method="POST" class="inline">
                                                                @csrf
                                                                @method('PATCH')
                                                                <button type="submit" title="Approve Testimoni"
                                                        ...
                                                        @else
                                                            <form action="{{ route('toggle.testimonial', $item->id) }}" method="POST" class="inline">
                                                                @csrf
                                                                @method('PATCH')
                                                                <button type="submit" title="Nonaktifkan Testimoni"
                                                        ...
                                                        <form action="{{ route('destroy.testimonial', $item->id) }}"
