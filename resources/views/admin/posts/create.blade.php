                            ...
                            <form action="{{ route('store.post') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        id="excerpt" name="excerpt" rows="3" placeholder="Masukkan kutipan singkat post">{{ old('excerpt') }}</textarea>
                                    @error('excerpt')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        id="content" name="content" rows="10" placeholder="Masukkan konten post">{{ old('content') }}</textarea>
                                    @error('content')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Anda dapat menggunakan HTML
                                        untuk format konten</p>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    @error('published_at')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Kosongkan untuk set otomatis
                                        saat publish</p>
                                </div>
