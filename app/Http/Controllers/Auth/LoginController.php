    ...
    public function login(Request $request)
    {
        ...
        if ($this->attemptLogin($request)) {
            ...
            if (! $user->is_active) {
                ...
                return $this->sendFailedLoginResponse($request, 'Akun Anda tidak aktif. Silakan hubungi administrator.');
            }

            if (! in_array($user->role, ['owner', 'admin', 'editor'])) {
                Auth::logout();

                return $this->sendFailedLoginResponse($request, 'Anda tidak memiliki akses ke halaman admin.');
            }
