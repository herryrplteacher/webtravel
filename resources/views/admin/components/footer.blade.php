<footer
    ...
    <div class="grid grid-cols-2 text-gray-500 dark:text-zinc-100">
        <div class="grow">
            ...
            </script> Tour & Travel. All Rights Reserved.
        </div>
        <div class="hidden md:inline-block text-end">Develop by <a href="" class=" text-violet-500">Herry Prasetyo
                <?php echo date('Y'); ?></a></div>
