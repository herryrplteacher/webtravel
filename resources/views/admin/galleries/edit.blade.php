                            ...
                            <form action="{{ route('update.gallery', $gallery->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input
                                        ...
                                        type="text" id="title" name="title" value="{{ old('title', $gallery->title) }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Masukkan deskripsi gambar (opsional)">{{ old('description', $gallery->description) }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input
                                        ...
                                        type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $gallery->sort_order) }}"
                                        min="0" placeholder="0">
                                    @error('sort_order')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
