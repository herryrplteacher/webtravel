                            ...
                            <form action="{{ route('update.menu', $menu->id) }}" method="POST">
                                ...
                                <div class="mb-4">
                                    <label class="block mb-2 font-medium text-gray-700 dark:text-gray-100"
                                        for="parent_id">Parent Menu</label>
                                    <select
                                        class="w-full placeholder:text-sm py-2 px-3 rounded border-gray-300 focus:border focus:border-violet-500 focus:ring focus:ring-violet-500/20 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-zinc-100 @error('parent_id') border-red-500 @enderror"
                                    ...
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Pilih parent menu jika ini
                                        adalah submenu. Kosongkan jika menu utama.</p>
                                </div>

                                <div class="mb-4">
                                    <label class="block mb-2 font-medium text-gray-700 dark:text-gray-100"
                                        for="title">Judul Menu <span class="text-red-500">*</span></label>
                                    <input
                                        ...
                                        placeholder="Contoh: Beranda, Tentang Kami, dll" maxlength="100" required>
                                    @error('title')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    <label class="block mb-2 font-medium text-gray-700 dark:text-gray-100"
                                        for="url">URL</label>
                                    <input
                                        class="w-full placeholder:text-sm py-2 px-3 rounded border-gray-300 focus:border focus:border-violet-500 focus:ring focus:ring-violet-500/20 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100 @error('url') border-red-500 @enderror"
                                        type="text" id="url" name="url" value="{{ old('url', $menu->url) }}"
                                        placeholder="/about atau https://example.com" maxlength="255">
                                    @error('url')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">URL tujuan menu. Bisa relatif
                                        (/) atau absolute (http://)</p>
                                </div>

                                <div class="mb-4">
                                    <label class="block mb-2 font-medium text-gray-700 dark:text-gray-100"
                                        for="sort_order">Urutan <span class="text-red-500">*</span></label>
                                    <input
                                    ...
                                    @error('sort_order')
                                        <p class="mt-1 text-sm text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Urutan tampilan menu (semakin
                                        kecil, semakin di atas)</p>
                                </div>
