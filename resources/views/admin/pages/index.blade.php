                                            ...
                                            <tr
                                                ...
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    <div class="flex gap-2">
                                                        <a href="{{ route('show.page', $item->id) }}"
                                                        ...
                                                        <form action="{{ route('destroy.page', $item->id) }}" method="POST"
                                                            class="inline"
