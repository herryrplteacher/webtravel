...
@section('title')
    <title>Tambah Fasilitas Route</title>
@endsection
                    ...
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <div class="card-body border-b border-gray-100 dark:border-zinc-600">
                            <h6 class="mb-1 text-gray-700 text-15 dark:text-gray-100 font-semibold">
                                Form Tambah Fasilitas Route
                            </h6>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('store.route_facilitie') }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <input
                                        ...
                                        type="text" id="label" name="label" value="{{ old('label') }}"
