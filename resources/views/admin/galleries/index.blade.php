                            ...
                            <li>
                                <div class="flex items-center rtl:mr-2">
                                    ...
                                    <a href="{{ route('index.gallery') }}"
                                        class="text-sm font-medium text-gray-500 ltr:ml-2 rtl:mr-2 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-100 dark:hover:text-white">Halaman Galeri</a>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <div class="card-body">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 ml-3">
                                ...
                                <p class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ $galleries->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 ml-3">
                                ...
                                <p class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ $galleries->where('is_active', true)->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 ml-3">
                                ...
                                <p class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ $galleries->where('is_active', false)->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr class="bg-white border-b border-gray-50 dark:bg-zinc-700 dark:border-zinc-600">
                                                ...
                                                <td class="px-6 py-3.5 dark:text-zinc-100">
                                                    <div class="flex gap-2">
                                                        <form action="{{ route('toggle.gallery', $item->id) }}" method="POST" class="inline">
                                                            @csrf
                                                            @method('PATCH')
                                                            @if(!$item->is_active)
                                                        ...
                                                        <form action="{{ route('destroy.gallery', $item->id) }}"
