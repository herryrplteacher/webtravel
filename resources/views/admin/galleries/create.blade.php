                            ...
                            <form action="{{ route('store.gallery') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    <label class="block mb-2 font-medium text-gray-700 dark:text-gray-100"
                                        for="title">Judul <span class="text-red-500">*</span></label>
                                    <input
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Masukkan deskripsi gambar (opsional)">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    <label class="block mb-2 font-medium text-gray-700 dark:text-gray-100"
                                        for="image">Gambar <span class="text-red-500">*</span></label>
                                    <input
                                    ...
                                    @error('image')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Format: JPG, JPEG, PNG, WEBP. Maksimal 2MB. Ukuran rekomendasi: 800x600px</p>

                                    <!-- Preview -->
                                    <div id="imagePreview" class="mt-3 hidden">
                                        <img id="previewImg" src="" alt="Preview"
                                            class="w-48 h-36 object-cover rounded border border-gray-300 dark:border-zinc-600">
                                    </div>
                                </div>
